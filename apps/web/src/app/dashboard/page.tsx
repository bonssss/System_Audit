      ...
      <div className="p-8 space-y-6 max-w-7xl">
        ...
        <div className="bg-surface border border-border rounded-2xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-sm transition-colors">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs text-muted-foreground">• 14 Scan Engines Synchronized</span>
              </div>
          ...
          <button
            ...
            className="flex-shrink-0 flex items-center gap-2 bg-foreground text-background hover:opacity-90 text-xs font-semibold px-5 py-2.5 rounded-lg transition-all shadow-sm"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="clean-card p-5">
            <div className="flex items-center justify-between text-muted-foreground text-xs font-medium uppercase tracking-wider">
              ...
              <div className="w-7 h-7 rounded-md bg-muted text-foreground flex items-center justify-center border border-border">
          ...
          <div className="clean-card p-5">
            <div className="flex items-center justify-between text-muted-foreground text-xs font-medium uppercase tracking-wider">
              ...
              <div className="w-7 h-7 rounded-md bg-rose-500/10 text-rose-600 dark:text-rose-400 flex items-center justify-center border border-rose-500/20">
          ...
          <div className="clean-card p-5">
            <div className="flex items-center justify-between text-muted-foreground text-xs font-medium uppercase tracking-wider">
              ...
              <div className="w-7 h-7 rounded-md bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center justify-center border border-amber-500/20">
        ...
        <div className="clean-card overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs text-foreground">
              <thead className="bg-muted/50 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground border-b border-border">
                <tr>
                    ...
                    return (
                      <tr key={p.id} className="hover:bg-surface-hover/80 transition-colors">
                        ...
                        <td className="py-3.5 px-5 font-mono text-[11px]">
                          <span className="bg-background text-foreground px-2 py-0.5 rounded border border-border">
                            {p.sourceType}
                          </span>
                        </td>
                        ...
                        <td className="py-3.5 px-5 font-mono">
                          {p.criticalIssuesCount > 0 ? (
                            <span className="text-rose-600 dark:text-rose-400 font-semibold bg-rose-500/10 px-2 py-0.5 rounded border border-rose-500/30">
                        ...
                        <td className="py-3.5 px-5 text-right">
                          <Link
                            href={`/projects/${p.id}`}
                            className="inline-flex items-center gap-1 bg-muted hover:bg-foreground hover:text-background text-foreground border border-border px-3 py-1 rounded text-xs font-medium transition-all"
                          >
                            <span>Inspect</span>
