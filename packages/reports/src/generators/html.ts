...
export function generateInteractiveHtmlReport(scan: ScanResult, projectName: string = 'AI Project Scanner'): string {
  ...
  <div class="container">
    <div class="header">
      <div>
        ...
        <div class="subtitle">Scan Date: ${new Date(scan.scanDate).toUTCString()} | Duration: ${scan.durationMs}ms | Engine: AI Project Scanner v1.0</div>
      </div>
